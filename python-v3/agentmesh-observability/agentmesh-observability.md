...
- PyPI 项目页：https://pypi.org/project/agentmesh-observability/
...
- pip 安装：`pip install agentmesh-observability`
- 下载页面：https://pypi.org/project/agentmesh-observability/#files
- 运行要求：Python >=3.10
