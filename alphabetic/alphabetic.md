...
- 官网：https://github.com/Halvani/alphabetic
- PyPI 项目页：https://pypi.org/project/alphabetic/
...
- pip 安装：`pip install alphabetic`
- 下载页面：https://pypi.org/project/alphabetic/#files
- 运行要求：Python >=3.9
